...
public class Kubbur {
     ...
     */
    private final String[] nums =  {"einn", "tveir", "thrir", "fjorir","fimm","sex","sjo","atta","niu"};//heldur utan um heitin á myndunum þ.e. nums[i-1] hefru nafnið
    //á mynd i
    ...
    /**
     * Smiður fyrir klasann Kubbur. Frumstillir kubbinn og gefur stig og fjolda upphafsgildi.
    ...
    /**
     * Frumstillir kubbinn. Setur níu mismunandi stykkin í slembiröð í tvívíða fylkið bord
