...
public class KubburController {
    ...
    /**
     * Bregst við því þegar notandi slær nýrri tölu inn í textasviðið. Það tekur sérhvern hnapp
     * sem ekki er búið að giska rétt á og er disabled, tekur myndina af honum og virkjar hann aftur.
    ...
    /**
     * Bregst við því þegar ýtt er á hnapp. Setur mynd á hnapp og gefur stig ef ýtt er
     * á "réttan" hnapp. Þrjú stig fyrir fyrstu tilraun, 2 fyrir aðra, eitt stig fyrir þriðju og
     * engin eftir það.
